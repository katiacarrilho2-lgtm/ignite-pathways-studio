...
const faqs = [
  ...
  },
  {
    ...
    a: "A duração varia conforme o plano escolhido: Técnico Regular de 6 a 12 meses; Tecnólogo a partir de 12 meses, com opções de 12, 18 ou 24 meses.",
  },
  {
      ...
      <section className="container py-12">
        ...
        <div className="grid md:grid-cols-4 gap-4">
          {[
            ...
            { n: "4", t: "Receba o diploma", d: "Conclusão de 6 a 12 meses (Técnico Regular) ou 12, 18 e 24 meses (Tecnólogo), com registro no SISTEC-MEC." },
          ].map((s) => (
